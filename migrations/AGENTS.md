...
- `004_provider_embeddings.sql` migrates existing Gemini vectors into separate embedding rows while preserving shared documents/passages. The old knowledge-state signature remains migration metadata, not a runtime compatibility gate.
